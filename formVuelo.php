          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" role="form" action="crud/enviarVuelo.php" method="POST"  enctype="multipart/form-data">

                  <div class="form-group">
                    <input type="timestamp" class="form-control" name="FechaSalida" placeholder="Ingrese la fecha de salida del vuelo">
                  </div>

                  <div class="form-group">
                    <input type="text" class="form-control" name="Origen" placeholder="Ingrese el origen del vuelo">
                  </div>

                  <div class="form-group">
                    <input type="text" class="form-control" name="Destino" placeholder="Ingrese el destino del vuelo">
                  </div>

                  <div class="form-group">
                    <button class="btn btn-round btn-b" type="submit" name="vuelo">Registrar vuelo</button>
                  </div>
...
<a scope="col" href="crud/eliminar7.php?id=<?php echo $fila['ID']?>"> 
<i class="fa fa-fw"> &#xF12D; </i> </a>

<a scope="col" href="actualizar6.php?id=<?php echo $fila['ID']?>" class="icon-edit"></a>
