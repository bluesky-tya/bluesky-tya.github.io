          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt">Reserva</h1>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  <input class="form-control" type="text" id="" name="" placeholder="Codigo de reserva"/>
                </div>
              </div>
              <div class="col-sm-3">
                <div class="form-group">
              ...
              <div class="col-sm-3 col-sm-offset-3">
                <div class="form-group">
                  <button class="btn btn-block btn-round btn-d pull-right" type="submit">Subir reserva</button>
                </div>
              </div>
            </div>
            <hr class="divider-w">
            <div class="row mt-70">
              <div class="col-sm-5 col-sm-offset-7">
                <div class="shop-Cart-totalbox">
                  <h4 class="font-alt">Total reservas</h4>
                  <table class="table table-striped table-border checkout-table">
                    <tbody>
                      <tr>
                        <th>Subtotal de reserva :</th>
                        <td>£40.00</td>
                      </tr>
                      <tr>
                  ...
                  <button class="btn btn-lg btn-block btn-round btn-d" type="submit">Proceder pago</button>
                </div>
              </div>
            </div>
          </div>
