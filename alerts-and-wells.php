          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">Alerts &amp; Wells</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h4 class="font-alt mb-0">Alerts</h4>
                <hr class="divider-w mt-10 mb-20">
                <div class="alert alert-success" role="alert"><strong>Alert!</strong> The European languages are members of the same family.</div>
                <div class="alert alert-info" role="alert"><strong>Alert!</strong> The European languages are members of the same family.</div>
                <div class="alert alert-warning" role="alert"><strong>Alert!</strong> The European languages are members of the same family.</div>
                <div class="alert alert-danger" role="alert"><strong>Alert!</strong> The European languages are members of the same family.</div>
