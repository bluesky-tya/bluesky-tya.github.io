...
?>
              ...
              <li class="dropdown"><a class="icon-profile-male" href="login_register.php" data-toggle="dropdown" style="position:absolute; color:#FFFFFF; font-size: 27px; padding: 14px; right:0px ; left: 28px; width:10; height:10;"></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="shop_product_col_3.php">Varios</a></li>
                  <li><a href="shop_checkout.php">Reservas</a></li>
                </ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" role="form" action="crud/enviarAerolinea.php" method="POST"  enctype="multipart/form-data">
                  <div class="form-group">
                    <input type="text" class="form-control" name="Nombre" placeholder="Ingrese nombre de la aerolinea">
                  </div>

                  <div class="form-group">
                    <button class="btn btn-round btn-b" type="submit" name="aerolinea">Registrar aerolinea</button>
                  </div>
...
<a scope="col" href="crud/eliminar1.php?id=<?php echo $fila['ID']?>"> 
<i class="fa fa-fw"> &#xF12D; </i> </a>

<a scope="col" href="actualizar.php?id=<?php echo $fila['ID']?>" class="icon-edit"></a>
