          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" role="form" action="crud/enviarAeropuerto.php" method="POST"  enctype="multipart/form-data">

                  <div class="form-group">
                    <input type="text" class="form-control" name="Nombre" placeholder="Ingrese el nombre del aeropuerto">
                  </div>

                  <div class="form-group">
                    <input type="text" class="form-control" name="Ciudad" placeholder="Ingrese la ciudad del aeropuerto">
                  </div>

                  <div class="form-group">
                    <button class="btn btn-round btn-b" type="submit" name="aeropuerto">Registrar aeropuerto</button>
                  </div>
...
<a scope="col" href="crud/eliminar2.php?id=<?php echo $fila['ID']?>"> 
<i class="fa fa-fw"> &#xF12D; </i> </a>

<a scope="col" href="actualizar1.php?id=<?php echo $fila['ID']?>" class="icon-edit"></a>
