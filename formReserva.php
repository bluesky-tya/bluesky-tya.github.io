          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" role="form" action="crud/enviarReserva.php" method="POST"  enctype="multipart/form-data">

                  <div class="form-group">
                    <input type="date" class="form-control" name="FechaReserva" placeholder="Ingrese la fecha de la reserva">
                  </div>

                  <div class="form-group">
                    <input type="text" class="form-control" name="Estado" placeholder="Ingrese el estado de la reserva">
                  </div>

                  <div class="form-group">
                    <button class="btn btn-round btn-b" type="submit" name="reserva">Registrar reserva</button>
                  </div>
...
<a scope="col" href="crud/eliminar5.php?id=<?php echo $fila['ID']?>"> 
<i class="fa fa-fw"> &#xF12D; </i> </a>

<a scope="col" href="actualizar4.php?id=<?php echo $fila['ID']?>" class="icon-edit"></a>
