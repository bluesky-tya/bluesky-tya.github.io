          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form class="form" role="form" action="crud/enviarAvion.php" method="POST"  enctype="multipart/form-data">

                  <div class="form-group">
                    <input type="text" class="form-control" name="Modelo" placeholder="Ingrese el modelo del avión">
                  </div>

                  <div class="form-group">
                    <input type="text" class="form-control" name="Capacidad" placeholder="Ingrese la capacidad del avión">
                  </div>

                  <div class="form-group">
                    <button class="btn btn-round btn-b" type="submit" name="avion">Registrar avión</button>
                  </div>
...
<a scope="col" href="crud/eliminar3.php?id=<?php echo $fila['ID']?>"> 
<i class="fa fa-fw"> &#xF12D; </i> </a>

<a scope="col" href="actualizar2.php?id=<?php echo $fila['ID']?>" class="icon-edit"></a>
