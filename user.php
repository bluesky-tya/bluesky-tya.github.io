...
if($_SESSION['documento']){
    ...
    <section class="module bg-dark-30" data-background="assets/images/section-4.jpg">
        ...
        <?php
    echo "Bienvenido, ".$_SESSION['documento']."<br>";
    ...
    ?>
      <section class="module" id="services">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Fuera de sesión</h2>
                <div class="module-subtitle font-serif">No has iniciado sesión para ver este contenido</div>
              </div>
            </div>
            </div>
        </section>
